...
let foodArray = ['tacos', 'pizza', 'fries', 'cheesecake']
...
console.log('Animal at back is', animalArray[animalArray.length-1]);
...
foodArray.push('curry');
console.log('Added new food to the end', foodArray);
...
foodArray.unshift('hotdog');
console.log('Added new food at front', foodArray);
